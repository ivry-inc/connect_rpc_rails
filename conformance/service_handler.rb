...
module Conformance
  ...
  # connect_rpc library. Only Unary is implemented; the rest raise unimplemented
  # (streaming and the Connect GET variant are out of scope for the unary spike,
  # and are excluded by conformance/config.yaml).
  class ServiceHandler
    ...
    def idempotent_unary(_request, _context)
      raise ConnectRpc::Error.new(:unimplemented, "the Connect GET variant is not supported")
    end
    ...
    def unimplemented(_request, _context) = raise ConnectRpc::Error.new(:unimplemented, "unimplemented")

    private def raise_streaming
      raise ConnectRpc::Error.new(:unimplemented, "streaming is not supported")
    end
    ...
    private def error_from(error, request_info)
      ...
      ConnectRpc::Error.new(code, error.message, details:)
    end
