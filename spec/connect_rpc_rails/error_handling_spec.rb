...
class BoomInterceptor < ConnectRpcRails::Interceptor
...
class SlowInterceptor < ConnectRpcRails::Interceptor
...
class MappedErrorController < ActionController::API
  ...
  connect_service Greet::V1::SERVICE_DESCRIPTOR,
    ...
    interceptors: [ConnectRpcRails::ExceptionMappingInterceptor.new(DemoTimeout => :unavailable), BoomInterceptor.new]
end
...
class MetadataErrorInterceptor < ConnectRpcRails::Interceptor
